...
- Automatic update of the Pterodactyl Panel (dependencies, database, cronjob, nginx).
- Automatic update of the Pterodactyl Wings (Docker, systemd).
...
To use the update scripts, simply run this command as root. The script will ask you whether you would like to install just the panel, just Wings or both.

```bash
bash <(curl -s (https://raw.githubusercontent.com/Friezer-85/pterodactyl-updater/main/update.sh)
```
